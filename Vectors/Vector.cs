...
#pragma warning restore 3001 // void* is not a CLS-Compliant argument type
        ...
        public unsafe void CopyTo(T[] destination, int startIndex)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(startIndex), String.Format(SR.Arg_ArgumentOutOfRangeException, startIndex));
            }
            if ((destination.Length - startIndex) < Count)
            {
                throw new ArgumentException(String.Format(SR.Arg_ElementsInSourceIsGreaterThanDestination, startIndex));
            }
        ...
        public unsafe T this[int index]
        {
            ...
            get
            {
                ...
                {
                    throw new IndexOutOfRangeException(String.Format(SR.Arg_ArgumentOutOfRangeException, index));
                }
                if (typeof(T) == typeof(byte))
                {
                    fixed (byte* basePtr = &register.byte_0)
