...
namespace Vim 
{
	public static partial class MathOps 
	{
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)] public static bool AlmostEquals(this float v1, float v2, float tolerance = Constants.Tolerance) => (v2 - v1).AlmostZero();
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)] public static bool AlmostEquals(this double v1, double v2, float tolerance = Constants.Tolerance) => (v2 - v1).AlmostZero();
